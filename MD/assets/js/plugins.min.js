!function(t) {
    t.MDChapter = function(e, n) {
        var o = (t.extend({}, t.fn.MDChapter.defaults, n),
        t(e))
          , i = t(".chapter__title", o)
          , a = (t(".chapter__content", o),
        function() {
            r()
        }
        )
...
function(t) {
    t.MDProject = function(e, n) {
        var o = (t.extend({}, t.fn.MDProject.defaults, n),
        t(e))
        ...
        this.expand = function() {
            return o.addClass("open"),
            a.css("height", "auto"),
            i.css("height", .54 * t(window).height()),
