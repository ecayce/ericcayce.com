!function(e, t) {
    ...
    function c(e, t, n, r) {
        if (it.acceptData(e)) {
            ...
            if (u && l[u] && (r || l[u].data) || void 0 !== n || "string" != typeof t)
                return u || (u = s ? e[a] = U.pop() || it.guid++ : a),
                l[u] || (l[u] = s ? {} : {
                    toJSON: it.noop
                }),
    ...
    function f(e, t, n) {
        if (it.acceptData(e)) {
            ...
            if (a[s]) {
                ...
                (n || (delete a[s].data,
                u(a[s]))) && (o ? it.cleanData([e], !0) : nt.deleteExpando || a != a.window ? delete a[s] : a[s] = null)
            }
        }
    }
    function d() {
    ...
    function m(e, t) {
        ...
        if (!o)
            ...
            n = e.childNodes || e; null != (r = n[i]); i++)
                !t || it.nodeName(r, t) ? o.push(r) : it.merge(o, m(r, t));
    ...
    function k(e) {
        var t = ht
          , n = Kt[e];
        return n || (n = S(e, t),
        "none" !== n && n || (Zt = (Zt || it("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement),
    ...
    function A(e, t) {
        for (var n, r, i, o = [], a = 0, s = e.length; s > a; a++)
            ...
            "" === r.style.display && At(r) && (o[a] = it._data(r, "olddisplay", k(r.nodeName)))) : (i = At(r),
    ...
    function j(e, t, n, r, i) {
        for (var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, a = 0; 4 > o; o += 2)
            "margin" === n && (a += it.css(e, n + Nt[o], !0, i)),
            r ? ("content" === n && (a -= it.css(e, "padding" + Nt[o], !0, i)),
            "margin" !== n && (a -= it.css(e, "border" + Nt[o] + "Width", !0, i))) : (a += it.css(e, "padding" + Nt[o], !0, i),
            "padding" !== n && (a += it.css(e, "border" + Nt[o] + "Width", !0, i)));
        return a
    }
    function L(e, t, n) {
        var r = !0
    ...
    function O(e, t, n) {
        var r, i, o, a, s, l, u, c, f = this, d = {}, p = e.style, h = e.nodeType && At(e), g = it._data(e, "fxshow");
        ...
        u = it.css(e, "display"),
        c = "none" === u ? it._data(e, "olddisplay") || k(e.nodeName) : u,
        "inline" === c && "none" === it.css(e, "float") && (nt.inlineBlockNeedsLayout && "inline" !== k(e.nodeName) ? p.zoom = 1 : p.display = "inline-block")),
        ...
        if (it.isEmptyObject(d))
            "inline" === ("none" === u ? k(e.nodeName) : u) && (p.display = u);
        else {
            g ? "hidden"in g && (h = g.hidden) : g = it._data(e, "fxshow", {}),
            o && (g.hidden = !h),
    ...
    function q(e, t, n) {
        var r, i, o = 0, a = bn.length, s = it.Deferred().always(function() {
            ...
            if (i)
                return !1;
            for (var t = hn || D(), n = Math.max(0, u.startTime + u.duration - t), r = n / u.duration || 0, o = 1 - r, a = 0, l = u.tweens.length; l > a; a++)
                u.tweens[a].run(o);
        ...
        s--); l > s; s++)
            if (null != (i = arguments[s]))
                for (r in i)
                    e = a[r],
                    n = i[r],
                    a !== n && (u && n && (it.isPlainObject(n) || (t = it.isArray(n))) ? (t ? (t = !1,
    ...
    it.extend({
        ...
        makeArray: function(e, t) {
            var r = t || [];
            return null != e && (n(Object(e)) ? it.merge(r, "string" == typeof e ? [e] : e) : J.call(r, e)),
            r
        },
        ...
        proxy: function(e, t) {
            ...
            t = e,
            e = i),
            it.isFunction(e) ? (n = G.call(arguments, 2),
            r = function() {
    ...
    var ut = function(e) {
        function t(e, t, n, r) {
            ...
            if ((t ? t.ownerDocument || t : I) !== H && L(t),
            t = t || H,
            n = n || [],
            s = t.nodeType,
            ...
            if (!r && F) {
                ...
                if (w.qsa && (!M || !M.test(e))) {
                    ...
                    1 === s && "object" !== t.nodeName.toLowerCase()) {
                        for (u = k(e),
                        (f = t.getAttribute("id")) ? p = f.replace(xt, "\\$&") : t.setAttribute("id", p),
                        p = "[id='" + p + "'] ",
                        l = u.length; l--; )
                            u[l] = p + d(u[l]);
            ...
            r(function(r, a, s, l) {
                ...
                if (r) {
                    if (o || e) {
                        ...
                        for (c = b.length; c--; )
                            (f = b[c]) && (u = o ? et(r, f) : d[c]) > -1 && (r[u] = !(a[u] = f))
                    }
                } else
        ...
        function b(e, n) {
            var i = n.length > 0
              ...
              , a = function(r, a, s, l, u) {
                var c, f, d, p = 0, h = "0", g = r && [], v = [], y = A, b = r || o && T.find.TAG("*", u), x = B += null == y ? 1 : Math.random() || .1, w = b.length;
        ...
        var x, w, T, C, S, k, E, N, A, P, j, L, H, D, F, M, O, V, q, R = "sizzle" + 1 * new Date, I = e.document, B = 0, z = 0, _ = n(), W = n(), $ = n(), X = function(e, t) {
            return e === t && (j = !0),
            0
        }, Q = 1 << 31, U = {}.hasOwnProperty, G = [], Y = G.pop, J = G.push, Z = G.push, K = G.slice, et = function(e, t) {
            for (var n = 0, r = e.length; r > n; n++)
                if (e[n] === t)
                    return n;
            return -1
        }, tt = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", nt = "[\\x20\\t\\r\\n\\f]", rt = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", it = rt.replace("w", "w#"), ot = "\\[" + nt + "*(" + rt + ")(?:" + nt + "*([*^$|!~]?=)" + nt + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + it + "))|)" + nt + "*\\]", at = ":(" + rt + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + ot + ")*)|.*)\\)|)", st = new RegExp(nt + "+","g"), lt = new RegExp("^" + nt + "+|((?:^|[^\\\\])(?:\\\\.)*)" + nt + "+$","g"), ut = new RegExp("^" + nt + "*," + nt + "*"), ct = new RegExp("^" + nt + "*([>+~]|" + nt + ")" + nt + "*"), ft = new RegExp("=" + nt + "*([^\\]'\"]*?)" + nt + "*\\]","g"), dt = new RegExp(at), pt = new RegExp("^" + it + "$"), ht = {
            ID: new RegExp("^#(" + rt + ")"),
            CLASS: new RegExp("^\\.(" + rt + ")"),
        ...
        }, gt = /^(?:input|select|textarea|button)$/i, mt = /^h\d$/i, vt = /^[^{]+\{\s*\[native \w/, yt = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, bt = /[+~]/, xt = /'|\\/g, wt = new RegExp("\\\\([\\da-f]{1,6}" + nt + "?|(" + nt + ")|.)","ig"), Tt = function(e, t, n) {
            var r = "0x" + t - 65536;
        ...
        try {
            Z.apply(G = K.call(I.childNodes), I.childNodes),
        ...
        L = t.setDocument = function(e) {
            ...
            (w.qsa = vt.test(r.querySelectorAll)) && (i(function(e) {
                D.appendChild(e).innerHTML = "<a id='" + R + "'></a><select id='" + R + "-\f]' msallowcapture=''><option selected=''></option></select>",
            ...
            (w.matchesSelector = vt.test(V = D.matches || D.webkitMatchesSelector || D.mozMatchesSelector || D.oMatchesSelector || D.msMatchesSelector)) && i(function(e) {
                w.disconnectedMatch = V.call(e, "div"),
                V.call(e, "[s!='']:x"),
                O.push("!=", at)
            }),
            ...
            q = t || vt.test(D.contains) ? function(e, t) {
            ...
            X = t ? function(e, t) {
                ...
                1 & n || !w.sortDetached && t.compareDocumentPosition(e) === n ? e === r || e.ownerDocument === I && q(I, e) ? -1 : t === r || t.ownerDocument === I && q(I, t) ? 1 : P ? et(P, e) - et(P, t) : 0 : 4 & n ? -1 : 1)
            }
            : function(e, t) {
                if (e === t)
                    return j = !0,
                ...
                if (!o || !s)
                    return e === r ? -1 : t === r ? 1 : o ? -1 : s ? 1 : P ? et(P, e) - et(P, t) : 0;
                if (o === s)
                    return a(e, t);
        ...
        t.matchesSelector = function(e, n) {
            ...
            n = n.replace(ft, "='$1']"),
            !(!w.matchesSelector || !F || O && O.test(n) || M && M.test(n)))
                try {
                    var r = V.call(e, n);
        ...
        T = t.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(e) {
                    var t, n = !e[6] && e[2];
                    return ht.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && dt.test(n) && (t = k(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t),
                    e[2] = n.slice(0, t)),
                    e.slice(0, 3))
                }
            },
            filter: {
                ...
                CHILD: function(e, t, n, r, i) {
                    ...
                    : function(t, n, l) {
                        var u, c, f, d, p, h, g = o !== a ? "nextSibling" : "previousSibling", m = t.parentNode, v = s && t.nodeName.toLowerCase(), y = !l && !s;
                        if (m) {
                            if (o) {
                                for (; g; ) {
                                    for (f = t; f = f[g]; )
                            ...
                            } else if (y && (u = (t[R] || (t[R] = {}))[e]) && u[0] === B)
                                d = u[1];
                            else
                                for (; (f = ++p && f && f[g] || (d = p = 0) || h.pop()) && ((s ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++d || (y && ((f[R] || (f[R] = {}))[e] = [B, d]),
                                f !== t)); )
                                    ;
                            return d -= i,
                            d === r || d % r === 0 && d / r >= 0
        ...
        k = t.tokenize = function(e, n) {
            ...
            u = T.preFilter; s; ) {
                ...
                s = s.slice(r.length));
                for (a in T.filter)
                    !(i = ht[a].exec(s)) || u[a] && !(i = u[a](i)) || (r = i.shift(),
                    o.push({
                        value: r,
                        type: a,
                        matches: i
        ...
        N = t.select = function(e, t, n, r) {
            var i, o, a, s, l, u = "function" == typeof e && e, f = !r && k(e = u.selector || e);
            if (n = n || [],
            1 === f.length) {
                if (o = f[0] = f[0].slice(0),
                o.length > 2 && "ID" === (a = o[0]).type && w.getById && 9 === t.nodeType && F && T.relative[o[1].type]) {
                    if (t = (T.find.ID(a.matches[0].replace(wt, Tt), t) || [])[0],
                    !t)
                        return n;
                    u && (t = t.parentNode),
                    e = e.slice(o.shift().value.length)
                }
                for (i = ht.needsContext.test(e) ? 0 : o.length; i-- && (a = o[i],
                !T.relative[s = a.type]); )
            ...
            return (u || E(e, f))(r, t, !F, n, bt.test(e) && c(t.parentNode) || t),
            n
        }
        ,
        w.sortStable = R.split("").sort(X).join("") === R,
    ...
    it.extend({
        ...
        when: function(e) {
            var t, n, r, i = 0, o = G.call(arguments), a = o.length, s = 1 !== a || e && it.isFunction(e.promise) ? a : 0, l = 1 === s ? e : it.Deferred(), u = function(e, n, r) {
                return function(i) {
                    n[e] = this,
    ...
    it.event = {
            ...
            if (m && (c = m.events)) {
                ...
                u = t.length; u--; )
                    ...
                    p) {
                        ...
                        l && !d.length && (f.teardown && f.teardown.call(e, h, m.handle) !== !1 || it.removeEvent(e, p, m.handle),
                        delete c[p])
                    } else
                        for (p in c)
                            it.event.remove(e, p + t[u], n, r, !0);
                it.isEmptyObject(c) && (delete m.handle,
                it._removeData(e, "events"))
            }
        },
        trigger: function(t, n, r, i) {
            var o, a, s, l, u, c, f, d = [r || ht], p = tt.call(t, "type") ? t.type : t, h = tt.call(t, "namespace") ? t.namespace.split(".") : [];
            if (s = c = r = r || ht,
            3 !== r.nodeType && 8 !== r.nodeType && !Ft.test(p + it.event.triggered) && (p.indexOf(".") >= 0 && (h = p.split("."),
            p = h.shift(),
            h.sort()),
            a = p.indexOf(":") < 0 && "on" + p,
            ...
            i || !u.trigger || u.trigger.apply(r, n) !== !1)) {
                if (!i && !u.noBubble && !it.isWindow(r)) {
                    ...
                    Ft.test(l + p) || (s = s.parentNode); s; s = s.parentNode)
                        d.push(s),
                        c = s;
                ...
                if (t.type = p,
                !i && !t.isDefaultPrevented() && (!u._default || u._default.apply(d.pop(), n) === !1) && it.acceptData(r) && a && r[p] && !it.isWindow(r)) {
                    c = r[a],
                    c && (r[a] = null),
        ...
        dispatch: function(e) {
            e = it.event.fix(e);
            var t, n, r, i, o, a = [], s = G.call(arguments), l = (it._data(this, "events") || {})[e.type] || [], u = it.event.special[e.type] || {};
            if (s[0] = e,
        ...
        fix: function(e) {
            ...
            for (a || (this.fixHooks[i] = a = Dt.test(i) ? this.mouseHooks : Ht.test(i) ? this.keyHooks : {}),
    ...
    it.Event = function(e, t) {
        ...
        this.type = e.type,
        this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && e.returnValue === !1 ? d : p) : this.type = e,
        t && it.extend(this, t),
    ...
    it.extend({
        clone: function(e, t, n) {
            ...
            if (nt.html5Clone || it.isXMLDoc(e) || !qt.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (Jt.innerHTML = e.outerHTML,
        ...
        buildFragment: function(e, t, n, r) {
            for (var i, o, a, s, l, u, c, f = e.length, d = g(t), p = [], h = 0; f > h; h++)
                ...
                o || 0 === o)
                    if ("object" === it.type(o))
                        ...
                        c = Gt[l] || Gt._default,
                        s.innerHTML = c[1] + o.replace(It, "<$1></$2>") + c[2],
                        i = c[0]; i--; )
                            s = s.lastChild;
                        if (!nt.leadingWhitespace && Rt.test(o) && p.push(t.createTextNode(Rt.exec(o)[0])),
                        !nt.tbody)
                            for (o = "table" !== l || zt.test(o) ? "<table>" !== c[1] || zt.test(o) ? 0 : s : s.firstChild,
            ...
            nt.appendChecked || it.grep(m(p, "input"), v),
            h = 0; o = p[h++]; )
        ...
        cleanData: function(e, t) {
            for (var n, r, i, o, a = 0, s = it.expando, l = it.cache, u = nt.deleteExpando, c = it.event.special; null != (n = e[a]); a++)
                ...
                o = i && l[i])) {
                    ...
                    l[i] && (delete l[i],
                    u ? delete n[s] : typeof n.removeAttribute !== Ct ? n.removeAttribute(s) : n[s] = null,
                    U.push(i))
                }
        }
    }),
    it.fn.extend({
        ...
        remove: function(e, t) {
            for (var n, r = e ? it.filter(e, this) : this, i = 0; null != (n = r[i]); i++)
                t || 1 !== n.nodeType || it.cleanData(m(n)),
                n.parentNode && (t && it.contains(n.ownerDocument, n) && w(m(n, "script")),
                n.parentNode.removeChild(n));
            return this
        },
        empty: function() {
            for (var e, t = 0; null != (e = this[t]); t++) {
                for (1 === e.nodeType && it.cleanData(m(e, !1)); e.firstChild; )
        ...
        domManip: function(e, t) {
            e = Y.apply([], e);
            var n, r, i, o, a, s, l = 0, u = this.length, c = this, f = u - 1, d = e[0], p = it.isFunction(d);
            if (p || u > 1 && "string" == typeof d && !nt.checkClone && $t.test(d))
                return this.each(function(n) {
                    var r = c.eq(n);
                    p && (e[0] = d.call(this, n, r.html())),
                    r.domManip(e, t)
                });
            if (u && (s = it.buildFragment(e, this[0].ownerDocument, !1, this),
            n = s.firstChild,
            1 === s.childNodes.length && (s = n),
            n)) {
                for (o = it.map(m(s, "script"), b),
                i = o.length; u > l; l++)
                    r = s,
                    l !== f && (r = it.clone(r, !0, !0),
                    i && it.merge(o, m(r, "script"))),
                    t.call(this[l], r, l);
                if (i)
                    ...
                    l = 0; i > l; l++)
                        r = o[l],
                        Xt.test(r.type || "") && !it._data(r, "globalEval") && it.contains(a, r) && (r.src ? it._evalUrl && it._evalUrl(r.src) : it.globalEval((r.text || r.textContent || r.innerHTML || "").replace(Ut, "")));
                s = n = null
            }
            return this
        }
    ...
    it.extend({
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                if (t = it.cssProps[s] || (it.cssProps[s] = N(l, s)),
        ...
        css: function(e, t, n, r) {
            ...
            return t = it.cssProps[s] || (it.cssProps[s] = N(e.style, s)),
            a = it.cssHooks[t] || it.cssHooks[s],
            a && "get"in a && (o = a.get(e, !0, n)),
            void 0 === o && (o = tn(e, t, r)),
            "normal" === o && t in dn && (o = dn[t]),
            "" === n || n ? (i = parseFloat(o),
    ...
    it.fx.step = {};
    var hn, gn, mn = /^(?:toggle|show|hide)$/, vn = new RegExp("^(?:([+-])=|)(" + Et + ")([a-z%]*)$","i"), yn = /queueHooks$/, bn = [O], xn = {
        "*": [function(e, t) {
    ...
    var Tn, Cn, Sn = it.expr.attrHandle, kn = /^(?:checked|selected)$/i, En = nt.getSetAttribute, Nn = nt.input;
    it.fn.extend({
        attr: function(e, t) {
    ...
    it.extend({
        attr: function(e, t, n) {
            ...
            if (e && 3 !== o && 8 !== o && 2 !== o)
                return typeof e.getAttribute === Ct ? it.prop(e, t, n) : (1 === o && it.isXMLDoc(e) || (t = t.toLowerCase(),
                r = it.attrHooks[t] || (it.expr.match.bool.test(t) ? Cn : Tn)),
        ...
        removeAttr: function(e, t) {
            ...
            if (o && 1 === e.nodeType)
                for (; n = o[i++]; )
                    r = it.propFix[n] || n,
                    it.expr.match.bool.test(n) ? Nn && En || !kn.test(n) ? e[r] = !1 : e[it.camelCase("default-" + n)] = e[r] = !1 : it.attr(e, n, ""),
    ...
    Cn = {
        set: function(e, t, n) {
            return t === !1 ? it.removeAttr(e, n) : Nn && En || !kn.test(n) ? e.setAttribute(!En && it.propFix[n] || n, n) : e[it.camelCase("default-" + n)] = e[n] = !0,
            n
        }
    },
        ...
        addClass: function(e) {
            ...
            if (u)
                for (t = (e || "").match(bt) || []; l > s; s++)
                    if (n = this[s],
                    r = 1 === n.nodeType && (n.className ? (" " + n.className + " ").replace(jn, " ") : " ")) {
                        for (o = 0; i = t[o++]; )
                            r.indexOf(" " + i + " ") < 0 && (r += i + " ");
                        a = it.trim(r),
    ...
    ;
    var Fn, Mn, On = /#.*$/, Vn = /([?&])_=[^&]*/, qn = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, Rn = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, In = /^(?:GET|HEAD)$/, Bn = /^\/\//, zn = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, _n = {}, Wn = {}, $n = "*/".concat("*");
    try {
        Mn = location.href
    } catch (Xn) {
    ...
    it.extend({
        ...
        ajax: function(e, t) {
            ...
            e = void 0),
            t = t || {};
            var r, i, o, a, s, l, u, c, f = it.ajaxSetup({}, t), d = f.context || f, p = f.context && (d.nodeType || d.jquery) ? it(d) : it.event, h = it.Deferred(), g = it.Callbacks("once memory"), m = f.statusCode || {}, v = {}, y = {}, b = 0, x = "canceled", w = {
                readyState: 0,
            ...
            w.success = w.done,
            w.error = w.fail,
            f.url = ((e || f.url || Mn) + "").replace(On, "").replace(Bn, Fn[1] + "//"),
            f.type = t.method || t.type || f.method || f.type,
            f.dataTypes = it.trim(f.dataType || "*").toLowerCase().match(bt) || [""],
            null == f.crossDomain && (r = zn.exec(f.url.toLowerCase()),
            f.crossDomain = !(!r || r[1] === Fn[1] && r[2] === Fn[2] && (r[3] || ("http:" === r[1] ? "80" : "443")) === (Fn[3] || ("http:" === Fn[1] ? "80" : "443")))),
            ...
            f.hasContent = !In.test(f.type),
            o = f.url,
            f.hasContent || (f.data && (o = f.url += (Hn.test(o) ? "&" : "?") + f.data,
            delete f.data),
            f.cache === !1 && (f.url = Vn.test(o) ? o.replace(Vn, "$1_=" + Ln++) : o + (Hn.test(o) ? "&" : "?") + "_=" + Ln++)),
            f.ifModified && (it.lastModified[o] && w.setRequestHeader("If-Modified-Since", it.lastModified[o]),
            ...
            w.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + $n + "; q=0.01" : "") : f.accepts["*"]);
            for (i in f.headers)
    ...
    it.offset = {
        setOffset: function(e, t, n) {
            var r, i, o, a, s, l, u, c = it.css(e, "position"), f = it(e), d = {};
...
function(e) {
    ...
    e.fn.waitForImages = function(n, r, i) {
        var o = 0
          , a = 0;
        if (e.isPlainObject(arguments[0]) && (i = arguments[0].waitForAll,
        r = arguments[0].each,
        ...
        return this.each(function() {
            ...
            e.each(l, function(i, l) {
                ...
                e(u).on("load." + t + " error." + t, function(e) {
                    return a++,
                    r.call(l.element, a, o, "load" == e.type),
                    a == o ? (n.call(s[0]),
                    !1) : void 0
                }),
                u.src = l.src
    ...
    if (!e.jQuery) {
        ...
        n.each = function(e, n, r) {
            ...
            if (r) {
                ...
                for (; a > o && (i = n.call(e[o], o, e[o]),
                i !== !1); o++)
                    ;
            else
                for (o in e)
                    if (i = n.call(e[o], o, e[o]),
                    i === !1)
                        break;
            return e
        }
        ...
        ,
        n.extend = function() {
            var e, t, r, i, o, a, s = arguments[0] || {}, l = 1, u = arguments.length, c = !1;
            ...
            l--); u > l; l++)
                if (null != (o = arguments[l]))
                    for (i in o)
                        ...
                        s[i] = n.extend(c, a, r)) : void 0 !== r && (s[i] = r));
            return s
        }
        ,
        n.queue = function(e, r, i) {
            ...
            if (e) {
                r = (r || "fx") + "queue";
                var a = n.data(e, r);
                return i ? (!a || n.isArray(i) ? a = n.data(e, r, o(i)) : a.push(i),
                a) : a || []
            }
        }
        ,
        ...
        n.uuid = 0;
        for (var i = {}, o = i.hasOwnProperty, a = i.toString, s = "Boolean Number String Function Array Date RegExp Object Error".split(" "), l = 0; l < s.length; l++)
...
function(e) {
    ...
    return function(e, t, n, r) {
        ...
        function l(e, n, r, i) {
            ...
            function p(t) {
                for (var n = 0, i = 1, o = b - 1; i != o && C[i] <= t; ++i)
                    n += x;
                --i;
            ...
            var C = w ? new Float32Array(b) : new Array(b)
              ...
              , k = function(t) {
                return S || h(),
                e === n && r === i ? t : 0 === t ? 0 : 1 === t ? 1 : l(p(t), n, i)
            };
        ...
        function u(e, t) {
            var n = e;
            return g.isString(e) ? b.Easings[e] || (n = !1) : n = g.isArray(e) && 1 === e.length ? s.apply(null, e) : g.isArray(e) && 2 === e.length ? x.apply(null, e.concat([t])) : g.isArray(e) && 4 === e.length ? l.apply(null, e) : !1,
                    ...
                    if (b.State.calls[o]) {
                        ...
                        for (var v = Math.min((t - p) / u.duration, 1), y = 0, x = l.length; x > y; y++) {
                            ...
                            if (a(S)) {
                                ...
                                for (var N in T)
                                    if ("element" !== N) {
                                        var A, P = T[N], j = g.isString(P.easing) ? b.Easings[P.easing] : P.easing;
                                        if (1 === v)
                                            A = P.endValue;
                                        else {
                                            var L = P.endValue - P.startValue;
                                            if (A = P.startValue + L * j(v, u, L),
                                            !h && A === P.currentValue)
                                                continue
                                        }
                                        if (P.currentValue = A,
                                        "tween" === N)
                                            ...
                                            w.Hooks.registered[N] && (a(S).rootPropertyValueCache[H] = w.Normalizations.registered[H] ? w.Normalizations.registered[H]("extract", null, F[1]) : F[1]),
                                            "transform" === F[0] && (k = !0)
                                        }
                                    }
                                u.mobileHA && a(S).transformCache.translate3d === r && (a(S).transformCache.translate3d = "(0px, 0px, 0px)",
                                k = !0),
                                k && w.flushTransformCache(S)
                            }
                        }
                        u.display !== r && "none" !== u.display && (b.State.calls[o][2].display = !1),
                        u.visibility !== r && "hidden" !== u.visibility && (b.State.calls[o][2].visibility = !1),
                        u.progress && u.progress.call(s[1], s[1], v, Math.max(0, p + u.duration - t), p, m),
                        1 === v && f(o)
                    }
            }
        ...
        function f(e, t) {
            ...
            for (var n = b.State.calls[e][0], i = b.State.calls[e][1], o = b.State.calls[e][2], s = b.State.calls[e][4], l = !1, u = 0, c = n.length; c > u; u++) {
                var f = n[u].element;
                if (t || o.loop || ("none" === o.display && w.setPropertyValue(f, "display", o.display),
                "hidden" === o.visibility && w.setPropertyValue(f, "visibility", o.visibility)),
                o.loop !== !0 && (d.queue(f)[1] === r || !/\.velocityQueueEntryFlag/i.test(d.queue(f)[1])) && a(f)) {
                    a(f).isAnimating = !1,
                    a(f).rootPropertyValueCache = {};
                    var p = !1;
                    d.each(w.Lists.transforms3D, function(e, t) {
                        var n = /^scale/.test(t) ? 1 : 0
                          , i = a(f).transformCache[t];
                        a(f).transformCache[t] !== r && new RegExp("^\\(" + n + "[^.]").test(i) && (p = !0,
                        delete a(f).transformCache[t])
                    }),
                    o.mobileHA && (p = !0,
                    delete a(f).transformCache.translate3d),
                    p && w.flushTransformCache(f),
                    w.Values.removeClass(f, "velocity-animating")
                }
                ...
                s && o.loop !== !0 && s(i),
                a(f) && o.loop === !0 && !t && (d.each(a(f).tweensContainer, function(e, t) {
        ...
        if (e.fn && e.fn.jquery ? (d = e,
        m = !0) : d = t.Velocity.Utilities,
        8 >= p && !m)
        ...
        var w = b.CSS = {
            ...
            Hooks: {
                ...
                register: function() {
                    ...
                    if (p)
                        for (n in w.Hooks.templates) {
                            ...
                            o.push(o.shift()),
                            w.Hooks.templates[n] = [i.join(" "), o.join(" ")])
                        }
                    for (n in w.Hooks.templates) {
                        r = w.Hooks.templates[n],
                        i = r[0].split(" ");
                ...
                extractValue: function(e, t) {
                    ...
                    if (n) {
                        var r = n[0]
                          , i = n[1];
                        return t = w.Hooks.cleanRootPropertyValue(r, t),
                        t.toString().match(w.RegEx.valueSplit)[i]
                    }
                    return t
                },
                injectValue: function(e, t, n) {
                    ...
                    if (r) {
                        var i, o, a = r[0], s = r[1];
                        return n = w.Hooks.cleanRootPropertyValue(a, n),
            ...
            Normalizations: {
                registered: {
                    clip: function(e, t, n) {
                        ...
                        case "extract":
                            var r;
                            return w.RegEx.wrappedValueAlreadyExtracted.test(n) ? r = n : (r = n.toString().match(w.RegEx.valueUnwrap),
                        ...
                        !function() {
                            ...
                            w.Normalizations.registered[t] = function(e, n, i) {
                                ...
                                case "inject":
                                    ...
                                    case "scal":
                                    case "scale":
                                        b.State.isAndroid && a(n).transformCache[t] === r && 1 > i && (i = 1),
                                        o = !/(\d)$/i.test(i);
                                        break;
                                    case "skew":
                                        o = !/(deg|\d)$/i.test(i);
                                    ...
                                    return o || (a(n).transformCache[t] = "(" + i + ")"),
                    ...
                    for (var e = 0; e < w.Lists.colors.length; e++)
                        !function() {
                            ...
                            w.Normalizations.registered[t] = function(e, n, i) {
                                ...
                                case "extract":
                                    var o;
                                    if (w.RegEx.wrappedValueAlreadyExtracted.test(i))
                                        o = i;
                                    else {
                                        var a, s = {
                                            black: "rgb(0, 0, 0)",
                                        ...
                                        /^[A-z]+$/i.test(i) ? a = s[i] !== r ? s[i] : s.black : w.RegEx.isHex.test(i) ? a = "rgb(" + w.Values.hexToRgb(i).join(" ") + ")" : /^rgba?\(/i.test(i) || (a = s.black),
                                        o = (a || i).toString().match(w.RegEx.valueUnwrap)[1].replace(/,(\s+)?/g, " ")
                                    }
                                    return 8 >= p || 3 !== o.split(" ").length || (o += " 1"),
                                    o;
                                case "inject":
                                    return 8 >= p ? 4 === i.split(" ").length && (i = i.split(/\s+/).slice(0, 3).join(" ")) : 3 === i.split(" ").length && (i += " 1"),
                                    (8 >= p ? "rgb" : "rgba") + "(" + i.replace(/\s+/g, ",").replace(/\.(\d)+(?=,)/g, "") + ")"
                                }
                            }
                        }()
                }
            ...
            getPropertyValue: function(e, n, i, o) {
                function s(e, n) {
                    ...
                    if (8 >= p)
                        ...
                        var u = !1;
                        if (/^(width|height)$/.test(n) && 0 === w.getPropertyValue(e, "display") && (u = !0,
                        ...
                        var h;
                        h = a(e) === r ? t.getComputedStyle(e, null) : a(e).computedStyle ? a(e).computedStyle : a(e).computedStyle = t.getComputedStyle(e, null),
                ...
                if (w.Hooks.registered[n]) {
                    var u = n
                      , c = w.Hooks.getRoot(u);
                    i === r && (i = w.getPropertyValue(e, w.Names.prefixCheck(c)[0])),
                    w.Normalizations.registered[c] && (i = w.Normalizations.registered[c]("extract", e, i)),
                    l = w.Hooks.extractValue(u, i)
                } else if (w.Normalizations.registered[n]) {
                    var f, h;
                    f = w.Normalizations.registered[n]("name", e),
                    "transform" !== f && (h = s(e, w.Names.prefixCheck(f)[0]),
            ...
            setPropertyValue: function(e, n, r, i, o) {
                ...
                if ("scroll" === n)
                    ...
                    w.Normalizations.registered[n]("inject", e, r),
                    s = "transform",
                    ...
                    if (w.Hooks.registered[n]) {
                        var l = n
                          , u = w.Hooks.getRoot(n);
                        i = i || w.getPropertyValue(e, u),
                        r = w.Hooks.injectValue(l, r, i),
                        n = u
                    }
                    if (w.Normalizations.registered[n] && (r = w.Normalizations.registered[n]("inject", e, r),
                    ...
                    8 >= p)
                        ...
                        a(e) && a(e).isSVG && w.Names.SVGAttribute(n) ? e.setAttribute(n, r) : e.style[s] = r;
            ...
            flushTransformCache: function(e) {
                ...
                if ((p || b.State.isAndroid && !b.State.isChrome) && a(e).isSVG) {
                    ...
                    d.each(a(e).transformCache, function(t) {
                        return i = a(e).transformCache[t],
                        "transformPerspective" === t ? (o = i,
        ...
        var T = function() {
            ...
            function i() {
                function e() {
                    function e(e, t) {
                        ...
                        !g.isArray(e[1]) && /^[\d-]/.test(e[1]) || g.isFunction(e[1]) || w.RegEx.isHex.test(e[1]) ? a = e[1] : (g.isString(e[1]) && !w.RegEx.isHex.test(e[1]) || g.isArray(e[1])) && (i = t ? e[1] : u(e[1], s.duration),
                        e[2] !== r && (a = e[2]))) : n = e,
                        t || (i = i || s.easing),
                        g.isFunction(n) && (n = n.call(o, S, C)),
                        g.isFunction(a) && (a = a.call(o, S, C)),
                        [n || 0, i, a]
                    }
                    function f(e, t) {
                        var n, r;
                    ...
                    function p() {
                        ...
                        if (i && r)
                            ...
                            l.percentToPxWidth = F.lastPercentToPxWidth = (parseFloat(w.getPropertyValue(u, "width", null, !0)) || 1) / s,
                            l.percentToPxHeight = F.lastPercentToPxHeight = (parseFloat(w.getPropertyValue(u, "height", null, !0)) || 1) / s,
                            l.emToPx = F.lastEmToPx = (parseFloat(w.getPropertyValue(u, "paddingLeft")) || 1) / s,
                            e.myParent.removeChild(u)
                        }
                        return null === F.remToPx && (F.remToPx = parseFloat(w.getPropertyValue(n.body, "fontSize")) || 16),
                    ...
                    if ("scroll" === A) {
                        var x, T, k, E = /^x$/i.test(s.axis) ? "Left" : "Top", P = parseFloat(s.offset) || 0;
                        s.container ? g.isWrapped(s.container) || g.isNode(s.container) ? (s.container = s.container[0] || s.container,
                        x = s.container["scroll" + E],
                        k = x + d(o).position()[E.toLowerCase()] + P) : s.container = null : (x = b.State.scrollAnchor[b.State["scrollProperty" + E]],
                        T = b.State.scrollAnchor[b.State["scrollProperty" + ("Left" === E ? "Top" : "Left")]],
                        k = d(o).offset()[E.toLowerCase()] + P),
                        l = {
                            scroll: {
                                rootPropertyValue: !1,
                                startValue: x,
                        ...
                        for (var L in j)
                            if ("element" !== L) {
                                ...
                                j[L].startValue = j[L].currentValue = j[L].endValue,
                                j[L].endValue = H,
                                g.isEmptyObject(y) || (j[L].easing = s.easing),
                                b.debug && console.log("reverse tweensContainer (" + L + "): " + JSON.stringify(j[L]), o)
                            }
                        l = j
                    } else if ("start" === A) {
                        var j;
                        a(o).tweensContainer && a(o).isAnimating === !0 && (j = a(o).tweensContainer),
                        d.each(m, function(t, n) {
                        ...
                        for (var D in m) {
                            ...
                            if (a(o).isSVG || "tween" === I || w.Names.prefixCheck(I)[1] !== !1 || w.Normalizations.registered[I] !== r) {
                                (s.display !== r && null !== s.display && "none" !== s.display || s.visibility !== r && "hidden" !== s.visibility) && /opacity|filter/.test(D) && !R && 0 !== V && (R = 0),
                                s._cacheValues && j && j[D] ? (R === r && (R = j[D].endValue + j[D].unitType),
                                B = a(o).rootPropertyValueCache[I]) : w.Hooks.registered[D] ? R === r ? (B = w.getPropertyValue(o, I),
                                R = w.getPropertyValue(o, D, B)) : B = w.Hooks.templates[I][1] : R === r && (R = w.getPropertyValue(o, D));
                                var z, _, W, $ = !1;
                                if (z = f(D, R),
                                R = z[0],
                                W = z[1],
                                z = f(D, V),
                                V = z[0].replace(/^([+-\/*])=/, function(e, t) {
                                    return $ = t,
                                    ""
                                }),
                                _ = z[1],
                                R = parseFloat(R) || 0,
                                V = parseFloat(V) || 0,
                                "%" === _ && (/^(fontSize|lineHeight)$/.test(D) ? (V /= 100,
                                _ = "em") : /^scale/.test(D) ? (V /= 100,
                                _ = "") : /(Red|Green|Blue)$/i.test(D) && (V = V / 100 * 255,
                                _ = "")),
                                /[\/*]/.test($))
                                    _ = W;
                                else if (W !== _ && 0 !== R)
                    ...
                    a(o).opts = s),
                    a(o).isAnimating = !0,
                    S === C - 1 ? (b.State.calls.push([M, h, s, null, N.resolver]),
                    b.State.isTicking === !1 && (b.State.isTicking = !0,
                    c())) : S++)
                }
                var i, o = this, s = d.extend({}, b.defaults, y), l = {};
                switch (a(o) === r && b.init(o),
                parseFloat(s.delay) && s.queue !== !1 && d.queue(o, s.queue, function(e) {
                ...
                s.queue === !1 ? s.delay ? setTimeout(e, s.delay) : e() : d.queue(o, s.queue, function(t, n) {
                    return n === !0 ? (N.promise && N.resolver(h),
            ...
            h = o(h)) {
                x ? (m = arguments[0].properties || arguments[0].p,
                y = arguments[0].options || arguments[0].o) : (m = arguments[p],
                y = arguments[p + 1]);
                var C = h.length
                  , S = 0;
                    ...
                    return d.each(b.State.calls, function(e, t) {
                        t && d.each(t[1], function(n, i) {
                            ...
                            return o === !0 || t[2].queue === o || y === r && t[2].queue === !1 ? void d.each(h, function(n, r) {
                                ...
                                d.queue(r, g.isString(y) ? y : "", [])),
                                "stop" === m ? (a(r) && a(r).tweensContainer && o !== !1 && d.each(a(r).tweensContainer, function(e, t) {
                    ...
                    if (!d.isPlainObject(m) || g.isEmptyObject(m)) {
                        if (g.isString(m) && b.Redirects[m]) {
                            var j = d.extend({}, y)
                              , L = j.duration
                              , H = j.delay || 0;
                            return j.backwards === !0 && (h = d.extend(!0, [], h).reverse()),
                            d.each(h, function(e, t) {
                                parseFloat(j.stagger) ? j.delay = H + parseFloat(j.stagger) * e : g.isFunction(j.stagger) && (j.delay = H + j.stagger.call(t, e, C)),
                                j.drag && (j.duration = parseFloat(L) || (/^(callout|transition)/.test(m) ? 1e3 : v),
                                j.duration = Math.max(j.duration * (j.backwards ? 1 - e / C : (e + 1) / C), .75 * j.duration, 200)),
                                b.Redirects[m].call(t, t, j || {}, e, C, h, N.promise ? N : r)
                            }),
                            e()
                        }
                        var D = "Velocity: First argument (" + m + ") was not a property map, a known action, or a registered redirect. Aborting.";
                        return N.promise ? N.rejecter(new Error(D)) : console.log(D),
                        e()
                    }
                    A = "start"
                }
        ...
        d.each(["Down", "Up"], function(e, t) {
            b.Redirects["slide" + t] = function(e, n, i, o, a, s) {
                var l = d.extend({}, n)
                  ...
                  , p = {};
                l.display === r && (l.display = "Down" === t ? "inline" === b.CSS.Values.getDisplayType(e) ? "inline-block" : "block" : "none"),
                l.begin = function() {
                    u && u.call(a, a);
                    for (var n in f) {
                        p[n] = e.style[n];
...
function(e, t) {
    ...
    function n(n) {
        ...
        g = n || {},
        g.isMobileSafari = k,
        g.isBadStockAndroid = E,
        (g.force || k || C || E || S || g.hacks && g.hacks.required(g)) && (g.hacks && g.hacks.initialize(g),
        b = !0,
        y = document.createElement("style"),
        y.id = "patched-viewport",
        ...
        f(function() {
            ...
            (g.force || C || t()) && (window.addEventListener("resize", n, !0),
            g._listeningToResize = !0),
            g.hacks && g.hacks.initializeEvents(g, i, n),
            i()
        })))
    }
    function r() {
    ...
    function a(e) {
        if (7 === e.type) {
            ...
            void (w.test(t) && (v.push([e, null, t]),
            g.hacks && g.hacks.findDeclarations(v, e, null, t)))
        }
        if (!e.style) {
            if (!e.cssRules)
                return;
        ...
        T.call(e.style, function(t) {
            ...
            w.lastIndex = 0,
            w.test(n) && (v.push([e, t, n]),
            g.hacks && g.hacks.findDeclarations(v, e, t, n))
        })
    }
    function s() {
        m = c();
        ...
        return v.forEach(function(i) {
            ...
            return a && a === e ? (a && !e && (e = a,
            t = s),
            void r.push(o.content)) : (r.length && (n.push(e + r.join("\n") + t),
            r.length = 0),
            void (a ? (e = a,
            t = s,
            r.push(o.content)) : (n.push(o.content),
            e = null,
            t = null)))
        }),
        r.length && n.push(e + r.join("\n") + t),
        S && n.push("* { content: normal !important; }"),
        n.join("\n\n")
    }
    function l(e, t, n) {
        var r, i = [];
        r = n.replace(w, u),
        g.hacks && (r = g.hacks.overwriteDeclaration(e, t, r)),
        t && (i.push(e.selectorText),
        r = t + ": " + r + ";");
        for (var o = e.parentRule; o; )
            i.unshift("@media " + o.media.mediaText),
            o = o.parentRule;
        return {
            selector: i,
            content: r
    ...
    function f(e) {
        ...
        T.call(document.styleSheets, function(e) {
            e.href && d(e.href) !== d(location.href) && (t++,
            p(e.ownerNode, n))
        }),
        t || e()
    }
    ...
    function p(e, t) {
        h(e.href, function() {
            ...
            n.media = e.media,
            n.setAttribute("data-href", e.href),
    ...
    var g, m, v, y, b = !1, x = window.navigator.userAgent, w = /([+-]?[0-9.]+)(vh|vw|vmin|vmax)/g, T = [].forEach, C = !1, S = x.indexOf("Opera Mini") > -1, k = /(iPhone|iPod|iPad).+AppleWebKit/i.test(x) && function() {
        var e = x.match(/OS (\d)/);
